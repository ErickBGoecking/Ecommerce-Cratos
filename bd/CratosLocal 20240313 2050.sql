...
INSERT INTO `pessoa` (`idpessoa`,`idgenero`,`foto`,`nome`,`sobrenome`,`nascimento`,`cpf`,`cnpj`,`telefone`,`email`,`senha`,`tentativa`,`tempo`,`cadastro`,`alteracao`,`ativo`) VALUES 
 (1,1,'luciano.png','LUCIANO','PETTERSEN','1980-02-10','040.497.396-58',NULL,'(33)99109-9977','lcpyes@hotmail.com','$2y$10$AAvw6xFPwa7DOyMay2pCN.14jVKtLc3ofv9X8eRaFeJozb9Ujwcpy',0,'2023-12-22 21:13:59','2023-12-05 12:14:01','2023-12-22 20:59:05','A');
