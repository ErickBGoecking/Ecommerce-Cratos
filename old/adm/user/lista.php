...
while ($row = $dados->fetch()) {
    ...
    $ativo = $row['Ativo'];
    if ($ativo == 'A') {
        $btnAtivo = '<a href="#" class="btn btn-sm btn-outline-primary" aria-current="page" title="Banner Ativado" id="btnStatus" onclick="statusGeral2(' . $idPessoa . ',\'usuarioStatus\',\'listarUsuario\',\''.$getPaginacao.'\');"><span class="mdi mdi-lock-open-check text-success"></span>Ativo</a>';
    } else {
        $btnAtivo = '<a href="#" class="btn btn-sm btn-outline-primary" aria-current="page" title="Banner Desativado"  id="btnStatus" onclick="statusGeral2(' . $idPessoa . ',\'usuarioStatus\',\'listarUsuario\',\''.$getPaginacao.'\');"><span class="mdi mdi-lock-check text-danger"></span> Desativado</a>';
}?>
        ...
        <div class="p-2">
            <div class="d-flex flex-md-row flex-column gap-2">
                ...
                <a href="#" class="btn btn-sm btn-outline-primary"
                            ...
                            data-bs-target="#modalUsuarioAlt"
