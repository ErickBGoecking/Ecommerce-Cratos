...
<div class="bg-body-tertiary" style="width:100%">
    <div class="d-flex flex-column flex-md-row">

        <?php include_once('barraLateral.php');?>

        <div class="conteúdo bg-body-secondary container-fluid pt-5 d-flex flex-md-row flex-column gap-3" style="min-height: 100vh; width:100%;">
                        ...
                        <div class="card-body d-flex flex-column gap-3">
                            ...
                            <div class="d-flex flex-column flex-md-row border-top">
                                ...
                                <div class="d-flex flex-column col-md-2 justify-content-center text-end">
                                    <p>de <del class="text-danger">412,<span style="font-size:smaller;margin-top:-5px;">95</span></del></p>
