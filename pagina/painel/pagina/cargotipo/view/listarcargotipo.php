...
<div class="card border border-0 shadow mb-3 p-1 px-3">
    <div class="card-body p-1">
        <div class="d-flex justify-content-between">
            <h4 class="card-title">@val="cargotipo_cargotipo"</h4>
            <div>
                <button class="btn" onclick="menuAcoes(true,'@val="cargotipo_idcargotipo"')">
                    <span class="mdi mdi-dots-vertical"></span>
                </button>
                <div id="@val="cargotipo_idcargotipo"" class="d-none botaoAcoes"
                    style="position:absolute;top:0;right:0; z-index:999;">
                    <div class="card">
                        <div class="d-flex justify-content-end p-2 bg-warning rounded-top">
                            <div>
                                <button class="btn btn-warning"
                                    onclick="menuAcoes(false,'@val="cargotipo_idcargotipo"')">
                                    <span class="mdi mdi-close"></span>
                                </button>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <a href="$link/cargotipo/editar/@val="cargotipo_idcargotipo"">
                            ...
                            <button class="btn btn-light d-flex justify-content-between" style="min-width:150px;"
                                onclick="msgBoxConfirmacao('cargotipo_@val="cargotipo_idcargotipo"')">
                                Deletar
...
$lista = listarGeral('idcargotipo,cargotipo',
'cargotipo ORDER BY cargotipo ASC');
...
include_once('pagina/painel/adm/pagina/cargotipo/view/modalcadastro.php');
?>
    ...
    <div class="toast-container top-50 start-50 translate-middle p-3">
        <div id="msboxVerifica" class="toast " role="alert" aria-live="assertive" aria-atomic="true">
            ...
            <div class="toast-body bg-danger text-light">
                Tem certeza que desaja escluir esse cargotipo?
...
function msgBoxConfirmacao($id) {
    ...
    btnConfirma.href = "<?= $_PREFIXO ?>adm/cargotipo/delete/" + $id
