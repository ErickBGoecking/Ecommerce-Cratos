...
<div class="card border border-0 shadow mb-3 p-1 px-3">
    <div class="card-body p-1">
        <div class="d-flex justify-content-between">
            <h4 class="card-title">@val="cargo_cargo"</h4>
            <div>
                <button class="btn" onclick="menuAcoes(true,'@val="cargo_idcargo"')">
                    <span class="mdi mdi-dots-vertical"></span>
                </button>
                <div id="@val="cargo_idcargo"" class="d-none botaoAcoes"
                    style="position:absolute;top:0;right:0; z-index:999;">
                    <div class="card">
                        <div class="d-flex justify-content-end p-2 bg-warning rounded-top">
                            <div>
                                <button class="btn btn-warning"
                                    onclick="menuAcoes(false,'@val="cargo_idcargo"')">
                                    <span class="mdi mdi-close"></span>
                                </button>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <a href="$link/cargo/editar/@val="cargo_idcargo"">
                            ...
                            <button class="btn btn-light d-flex justify-content-between" style="min-width:150px;"
                                onclick="msgBoxConfirmacao('cargo_@val="cargo_idcargo"')">
                                Deletar
...
$lista = listarGeral('idcargo,cargo',
'cargo ORDER BY cargo ASC');
...
include_once('pagina/painel/adm/pagina/cargo/view/modalcadastro.php');
?>
    ...
    <div class="toast-container top-50 start-50 translate-middle p-3">
        <div id="msboxVerifica" class="toast " role="alert" aria-live="assertive" aria-atomic="true">
            ...
            <div class="toast-body bg-danger text-light">
                Tem certeza que desaja escluir esse cargo?
...
function msgBoxConfirmacao($id) {
    ...
    btnConfirma.href = "<?= $_PREFIXO ?>adm/cargo/delete/" + $id
