    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo $_PREFIXO?>adm/cargotipo/cadastrar" method="post" id="frmCadastrar">
                    <label for="">cargotipo:</label>
                    <input type="text" class="form-control" name="cargotipo_cargotipo" required>
                </form>
            </div>
